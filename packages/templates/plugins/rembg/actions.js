...
module.exports = (t) => [
  // ── 动作 1：去背景（自适应输入）────────────────────────
  {
    ...
    properties: [
      ...
      {
        key: 'alphaMatting',
        label: t('field.alphaMatting.label', 'Alpha Matting'),
        type: 'checkbox',
        dataType: 'boolean',
        tooltip: t('field.alphaMatting.tooltip', 'Enable Alpha Matting for finer edges. Slower than default.'),
      },
      {
        key: 'af',
      ...
      {
        key: 'ae',
        label: t('field.ae.label', 'Erosion Size'),
        type: 'number',
        dataType: 'number',
        min: 0,
        max: 255,
        tooltip: t('field.ae.tooltip', '0-255, default 10'),
      },
      {
        key: 'maskOnly',
        label: t('field.maskOnly.label', 'Only Mask'),
        type: 'checkbox',
        dataType: 'boolean',
        tooltip: t('field.maskOnly.tooltip', 'Return black/white mask instead of transparent PNG.'),
      },
      {
        key: 'postProcessMask',
      ...
      {
        key: 'extras',
        label: t('field.extras.label', 'Arguments (extras)'),
        type: 'textarea',
        dataType: 'object',
        tooltip: t(
          'field.extras.tooltip',
          'JSON object passed to rembg remove(), e.g. SAM prompt {"sam_prompt":[...]}.',
        ),
      },
    ],
