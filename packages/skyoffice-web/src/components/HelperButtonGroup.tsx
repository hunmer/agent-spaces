        ...
        {showControlGuide && (
          <Wrapper>
            ...
            <ul>
              ...
              <li>
                <strong>R</strong> to use vending machine (when facing one)
              </li>
              <li>
                <strong>Enter</strong> to toggle Agent Activity feed
              </li>
              <li>
                <strong>ESC</strong> to close feed
              </li>
            </ul>
            <p className="tip">
              <LightbulbIcon />
              Agents are driven externally via HTTP API / WebSocket broadcast
            </p>
          </Wrapper>
        )}
      </div>
