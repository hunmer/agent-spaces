...
export const sittingShiftData: Record<SittingDirection, number[]> = {
  up: [0, 3, -10],
  down: [0, 3, 1],
  left: [0, -8, 10],
  right: [0, -8, 10],
...
export default class Player extends Phaser.Physics.Arcade.Sprite {
  ...
  constructor(
    ...
    this.playerContainer = this.scene.add.container(this.x, this.y - 30).setDepth(this.depth)
  ...
  setDepth(value: number): this {
    ...
    this.playerContainer?.setDepth(value)
    return this
  }
