...
const agentRunProperties: NodeTypeDefinition['properties'] = [
...
export const aiNodes: NodeTypeDefinition[] = [
  ...
  {
    type: 'agent_intent',
    label: 'nodes.agent_intent.label',
    category: 'nodes.categories.ai',
    icon: 'ScanSearch',
    description: 'nodes.agent_intent.description',
    properties: agentRunProperties,
