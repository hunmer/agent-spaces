...
import { cn } from "@/components/ui/coss/lib/utils";
...
export function DialogHeader({
  ...
  const defaultProps = {
    className: cn(
      "flex flex-col gap-2 pb-6 in-[[data-slot=dialog-popup]:has([data-slot=dialog-panel])]:pb-3 max-sm:pb-4",
      className,
    ),
...
export function DialogFooter({
  ...
  const defaultProps = {
    className: cn(
      ...
      variant === "default" && "-mx-6 -mb-6 border-t bg-muted/72 px-6 py-4",
      variant === "bare" &&
