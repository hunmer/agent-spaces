  ...
  return (
    <NodeShell id={id} nodeType={NODE_TYPES.ipSpriteSplit} data={data} selected={selected} targetHandle sourceHandle>
      ...
      {upstreamImages.length > 0 && (
        <UpstreamImageList nodeId={id} urls={upstreamImages} resources={data?.imageResources} sortable onChangeOrder={(next) => onUpdate?.({ upstreamOrder: next })} onDelete={data?.onDeleteUpstreamImage} nonDeletableUrls={data?.protectedUpstreamImageUrls} />
      )}
