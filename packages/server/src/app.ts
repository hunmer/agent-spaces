...
import workflowSettingsRouter from './routes/workflow-settings.js';
import subscriptionRouter from './routes/subscription.js';
import agentSseRouter from './routes/agent-sse.js';
import searchRouter from './routes/search.js';
import notificationRouter from './routes/notification.js';
import notificationsGlobalRouter from './routes/notifications-global.js';
...
app.use('/api/team-inbox', teamInboxRouter);
app.use('/api/team-messages', teamMessageRouter);
...
app.use('/api/notifications', notificationsGlobalRouter);
app.use('/api/agents', agentRouter);
app.use('/api', llmRouter);
app.use('/api/model-catalog', modelCatalogRouter);
app.use('/api/folder', folderRouter);
app.use('/api/skills', skillRouter);
app.use('/api/skills-packages', skillsPackageRouter);
...
app.use('/api/external-import', externalImportRouter);
