...
import { createIssueFunctionTools, createTeamFunctionTools, createCommandFunctionTools, createDatabaseFunctionTools, createWorkflowExecutionFunctionTools, createMiniAppFunctionTools } from '../services/builtin-tools/index.js';
...
export async function runMentionedAgent(
  ...
  const functionTools = [
    ...
    ...createTeamFunctionTools(workspaceId, preset.tools),
